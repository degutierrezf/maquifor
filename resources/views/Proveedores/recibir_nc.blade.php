...
@section('contentheader_title')
    ERP - SISTEMA DE CONTROL - RECEPCIÓN NC -
@endsection
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="favoritesModalLabel">Agregar Nota de Crédito Proveedor </h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" name="form" action="{{ url('Proveedores/RecibirNC') }}" role="form"
                          method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-warning">
                                <i class="fa fa-check "></i> Agregar NC a Proveedor
                            </button>
