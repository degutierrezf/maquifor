...
@section('content')
    ...
    <div id="app">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">Reingrese la nueva contraseña para el sistema</p>
            <form action="{{ url('/password/reset') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Clave" name="password_confirmation"/>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
            ...
            <a href="{{ url('/login') }}">Iniciar Sesión sin cambiar Clave</a><br>
